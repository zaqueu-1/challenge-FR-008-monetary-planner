...
> Aplicação de planejamento financeiro que ajuda a medir o gasto ideal diário, baseado em um valor de entrada e o quanto se deseja guardar. Parte integrante do desafio React proposto pelo @JCDMeira, que consiste em concluir 20 desafios em 7 dias. Utilizei ReactJS e NextJS.

## 🛠️ Ajustes e melhorias
Tudo certo por enquanto!

## 🚀 Deploy
https://challenge-FR-008-monetary-planner.vercel.app/

## 🖼️ Demonstração
![demo](https://github.com/zaqueu-1/challenge-FR-008-monetary-planner/blob/main/github/demo.png)
